...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "tray.proxy_mode": "代理模式",
        "tray.system_proxy": "系统代理",
        "tray.tun_mode": "TUN 模式",
        "tray.disable_all": "全部关闭",
        "tray.restart_proxy": "重启代理",
        "tray.quit": "退出",
        # 托盘提示
        "tray.tooltip_running": "Venlta - 代理运行中",
        "tray.tooltip_stopped": "Venlta - 代理已停止",
        "tray.mode_system_proxy": "系统代理",
        "tray.mode_tun": "TUN",
        # 托盘通知
    ...
    "en": {
        ...
        "tray.proxy_mode": "Proxy Mode",
        "tray.system_proxy": "System Proxy",
        "tray.tun_mode": "TUN Mode",
        "tray.disable_all": "Disable All",
        "tray.restart_proxy": "Restart Proxy",
        "tray.quit": "Quit",
        # Tray tooltip
        "tray.tooltip_running": "Venlta - Proxy Running",
        "tray.tooltip_stopped": "Venlta - Proxy Stopped",
        "tray.mode_system_proxy": "System Proxy",
        "tray.mode_tun": "TUN",
        # Tray notification
        "tray.notification_minimized_title": "Venlta",
